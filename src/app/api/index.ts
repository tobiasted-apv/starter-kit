...
export type LifeDataFragment = { __typename?: 'Life', id: string, firstName: string, lastName: string, fullName: string, description: string, birthday: string | Date, hobbies: Array<string>, title: string };
